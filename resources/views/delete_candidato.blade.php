        ...
        <div class="row justify-content-center">
            <div class="col">
                ...
                <div class="col card p-5 text-center">
                    ...
                    <h4 class="text-info mb-3">{{ $candidato->name }}</h4>
                    <p class="text-secondary">Tem certeza que deseja deletar sua conta?</p>
                    <div class="mt-3">
                        <a href="{{ route('home') }}" class="btn btn-primary px-5 m-2"><i
                                class="fa-solid fa-xmark me-2"></i>Não</a>
                        <a href="{{ route('deleteCandidatoConfirm', ['id' => Crypt::encrypt($candidato->id)]) }}"
